...
export async function generateMockData() {
  const mainWindowDPP = {
    ...
    metadata: {
      ...
      image_url: `${import.meta.env.BASE_URL || '/'}images/window.png`,
    },
    version: 1,
  ...
  const glassDPP = {
    ...
    metadata: {
      ...
      image_url: `${import.meta.env.BASE_URL || '/'}images/glass.png`,
    },
    version: 1,
    previous_version_id: null,
  };
  ...
  const frameDPP = {
    ...
    metadata: {
      ...
      image_url: `${import.meta.env.BASE_URL || '/'}images/frame.png`,
    },
    version: 1,
    previous_version_id: null,
  };
