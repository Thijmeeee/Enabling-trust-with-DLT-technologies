      ...
      <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border border-blue-200">
        <div className="flex items-center justify-between">
          <div className="flex flex-col items-center flex-1">
            ...
            <span className="text-sm font-medium text-gray-700">1. DPP Event</span>
            <span className="text-xs text-gray-500">Product event occurs</span>
          </div>
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <span className="text-xs text-gray-500">Authority verifies</span>
          </div>
          <div className="flex-shrink-0 w-8 h-0.5 bg-gray-300 mx-2"></div>
          <div className="flex flex-col items-center flex-1">
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <span className="text-xs text-gray-500">Record on DPP</span>
          </div>
        </div>
      </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900">
                      {attestation.attestation_type.replace(/_/g, ' ').replace(/\b\w/g, (l) => l.toUpperCase())}
                    </h4>
