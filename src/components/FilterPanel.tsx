...
import { Search, Filter, X, ChevronDown, Square, Maximize } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-gray-200">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-500 focus:border-blue-500"
            >
              <option value="">All</option>
              {stats?.byStatus && Object.keys(stats.byStatus).map((status) => (
          ...
          <div>
            ...
            <input
              ...
              placeholder="Filter on owner DID..."
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
        </div>
