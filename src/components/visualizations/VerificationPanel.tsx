      ...
      <div className="border-b border-gray-200 dark:border-gray-700 p-4 flex items-center justify-between bg-gray-50 dark:bg-gray-900/50">
        ...
        <div className="flex items-center gap-2">
          {isVerifying ? (
            ...
            <button onClick={onPlay} className="px-8 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg flex items-center gap-2 font-bold uppercase text-sm tracking-widest transition-all shadow-lg shadow-emerald-500/20 active:scale-95 animate-pulse-subtle">
      ...
      <div className="p-6">
        {!isComplete ? (
          <div className="space-y-6">
            ...
            <div className="bg-indigo-600 rounded-xl p-4 text-white shadow-lg shadow-indigo-600/20 transform transition-transform animate-pulse">
            ...
            <div className="mt-6 pt-6 border-t border-current/10 w-full grid grid-cols-2 gap-4">
              <div className="text-left">
                ...
                <div className={`font-mono text-[10px] truncate ${!isValid && 'text-red-600 dark:text-red-400 font-bold'}`}>
                  {truncateHash(steps[steps.length-1]?.output, showFullHashes)}
                </div>
              </div>
