    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-gray-100 px-6 py-6">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-2xl font-bold text-gray-900">Welcome, Manufacturer</h1>
          <p className="text-gray-500 mt-1">What would you like to do today?</p>
        </div>
      </div>

      <div className="max-w-2xl mx-auto px-6 py-8">
        {/* Main Action - Big Button - White/Clean Theme */}
        <div className="mb-8">
          <button
            onClick={onRegisterWindow}
            className="w-full bg-gray-900 hover:bg-gray-800 text-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.02] active:scale-[0.98] border-2 border-gray-900"
          >
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                ...
                <span className="text-gray-300 text-sm mt-1 block">Click here to add a new product</span>
              </div>
            </div>
          </button>
        </div>

        {/* Today's Stats - Clean White Card */}
        <div className="bg-white rounded-xl border-2 border-gray-100 p-6 mb-8 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-gray-500 font-medium">Registered Today</p>
                <p className="text-4xl font-bold text-gray-900">{todayCount}</p>
              </div>
            </div>
